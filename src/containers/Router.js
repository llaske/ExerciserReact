...
import FreeTextInputPlay from "./Players/FreeTextInputPlayer";
    ...
    return(
        <div className="main-container">
            <Switch>
                ...
                {/* // FREE TEXT INPUT */}
                <Route exact path="/new/freetextInput" render={props=><FreeTextInputForm {...props}/>}/>
                <Route exact path="/edit/freetextInput" render={props=><FreeTextInputForm {...props}/>}/>
                <Route exact path="/play/freetextInput" render={props=><FreeTextInputPlay {...props}/>}/>
